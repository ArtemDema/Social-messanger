...
const settingsChatDiv = document.querySelector("#settings-chat");
...
const menuSettings = document.querySelector('.settings-menu')
const chatSettings = document.querySelector('.chat-settings')
const chatAdminSettings = document.querySelector('.chat-admin-settings')
...
backChat.addEventListener('click', ()=>{
    ...
    settingsChatDiv.style.display = "none"
...
async function getGroupUsers(id){ 
    ...
    if (data.success){
        settingsChatDiv.style.display = "flex"; 

        listGroupUsers = data.users_id
        listOnlineGroupUsers = data.online_users_id

        const existingCount = chatName.querySelector("p");
        ...
        if (data.group_admin.id == data.current_user.id){
            chatAdminSettings.classList.add('member-settings')
            chatSettings.classList.remove('member-settings')
            console.log('is admin')
            }else{
             chatAdminSettings.classList.remove('member-settings')
            chatSettings.classList.add('member-settings')
